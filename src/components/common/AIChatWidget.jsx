  ...
  const handleSendMessage = (textToSend) => {
    ...
    setTimeout(() => {
      ...
      if (lower.includes('กู้') || lower.includes('ดอกเบี้ยกู้')) {
        reply = `💸 **ข้อมูลเงินกู้สหกรณ์ระยอง:**\n- **กู้ฉุกเฉิน:** ดอกเบี้ย 5.50% วงเงินสูงสุด 50,000 บ. อนุมัติใน 24 ชม.\n- **กู้สามัญ:** ดอกเบี้ย 4.95% สูงสุด 3,000,000 บ. ผ่อนได้สูงสุด 240 งวด\n- **กู้พิเศษเคหะ:** ดอกเบี้ย 4.75% สูงสุด 5,000,000 บ. ผ่อน 30 ปี\n\n👉 สามารถกดเมนู "คำนวณเงินกู้" หรือยื่นคำขอออนไลน์ได้เลยครับ!`;
